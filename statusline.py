  ...
  "tipGroups": [
    ...
    },
    {
      ...
      "entries": [
        ...
        {
          "headline": "[Cross-session messaging](/docs/en/cross-session-messaging): let the sessions you run yourself pass findings to each other",
          "tier": 2,
          "category": "general",
          "before": null,
          "after": null
    ...
    },
    {
      ...
      "entries": [
        ...
        {
          "headline": "/cd — Move this session to a new working directory, keeping the conversation.",
          "tier": 2,
          "category": "general",
          "before": null,
          "after": null
        ...
        {
          "headline": "/design — Draft UI mockups, screen flows, landing pages, or posters as artboards on one canvas, published as an artifact that runs a research preview of Claude Design’s editor, for example /design a settings screen for a mobile banking app.",
          "tier": 2,
          "category": "general",
          "before": null,
          "after": null
        ...
        {
          "headline": "/rate-limit-options — Show ways to keep working when a claude.ai usage limit blocks a request: wait and continue automatically when the limit resets, add usage credits, or upgrade your plan.",
          "tier": 2,
          "category": "general",
          "before": null,
          "after": null
        ...
        {
          "headline": "/terminal-setup — Install a Shift+Enter keybinding for newlines in VS Code, Cursor, Devin Desktop, Alacritty, or Zed.",
          "tier": 2,
          "category": "general",
          "before": null,
          "after": null
        ...
        {
          "headline": "/workflow-authoring — Load the reference for writing dynamic workflow scripts: the script API, resume behavior, quality patterns, and worked examples.",
          "tier": 2,
          "category": "general",
          "before": null,
          "after": null
