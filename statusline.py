...
_TIPS = [
    ...
    {'headline': 'Claude Code on the web', 'before': None, 'after': None},
    {'headline': 'Claude Code on desktop', 'before': None, 'after': None},
    {'headline': '**Reference files with `@`** instead of describing where code lives. Claude reads the file before responding.', 'before': None, 'after': None},
    {'headline': '**Paste images directly**. Copy/paste or drag and drop images into the prompt.', 'before': None, 'after': None},
    {'headline': '**Give URLs** for documentation and API references. Use `/permissions` to allowlist frequently-used domains.', 'before': None, 'after': None},
    {'headline': '**Pipe in data** by running `cat error.log | claude` to send file contents directly.', 'before': None, 'after': None},
    {'headline': '**Let Claude fetch what it needs**. Tell Claude to pull context itself using Bash commands, MCP tools, or by reading files.', 'before': None, 'after': None},
    {'headline': 'Use ES modules (import/export) syntax, not CommonJS (require)', 'before': None, 'after': None},
    {'headline': 'Destructure imports when possible (eg. import { foo } from \'bar\')', 'before': None, 'after': None},
    {'headline': 'Be sure to typecheck when you\'re done making a series of code changes', 'before': None, 'after': None},
    {'headline': 'Prefer running single tests, and not the whole test suite, for performance', 'before': None, 'after': None},
    {'headline': 'Git workflow: @docs/git-instructions.md', 'before': None, 'after': None},
    {'headline': 'Personal overrides: @~/.claude/my-project-instructions.md', 'before': None, 'after': None},
    {'headline': '**Home folder (`~/.claude/CLAUDE.md`)**: applies to all Claude sessions', 'before': None, 'after': None},
    {'headline': '**Project root (`./CLAUDE.md`)**: check into git to share with your team', 'before': None, 'after': None},
    {'headline': '**Project root (`./CLAUDE.local.md`)**: personal project-specific notes; add this file to your `.gitignore` so it isn’t shared with your team', 'before': None, 'after': None},
    {'headline': '**Parent directories**: useful for monorepos where both `root/CLAUDE.md` and `root/foo/CLAUDE.md` are pulled in automatically', 'before': None, 'after': None},
    {'headline': '**Child directories**: Claude pulls in child CLAUDE.md files on demand when working with files in those directories', 'before': None, 'after': None},
    {'headline': '**Auto mode**: a separate classifier model reviews commands and blocks only what looks risky: scope escalation, unknown infrastructure, or hostile-content-driven actions. Best when you trust the general direction of a task but don’t want to click through every step', 'before': None, 'after': None},
    {'headline': '**Permission allowlists**: permit specific tools you know are safe, like `npm run lint` or `git commit`', 'before': None, 'after': None},
    {'headline': '**Sandboxing**: enable OS-level isolation that restricts filesystem and network access, allowing Claude to work more freely within defined boundaries', 'before': None, 'after': None},
    {'headline': 'Use kebab-case for URL paths', 'before': None, 'after': None},
    {'headline': 'Use camelCase for JSON properties', 'before': None, 'after': None},
    {'headline': 'Always include pagination for list endpoints', 'before': None, 'after': None},
    {'headline': 'Version APIs in the URL path (/v1/, /v2/)', 'before': None, 'after': None},
    {'headline': 'Injection vulnerabilities (SQL, XSS, command injection)', 'before': None, 'after': None},
    {'headline': 'Authentication and authorization flaws', 'before': None, 'after': None},
    {'headline': 'Secrets or credentials in code', 'before': None, 'after': None},
    {'headline': 'Insecure data handling', 'before': None, 'after': None},
    {'headline': 'How does logging work?', 'before': None, 'after': None},
    # AUTO-GENERATED:END
    ...
    {'headline': '/add-dir — Add a working directory for file access during the current session.', 'before': None, 'after': None},
    {'headline': '/agents — Manage agent configurations', 'before': None, 'after': None},
    {'headline': '/autofix-pr — Spawn a Claude Code on the web session that watches the current branch’s PR and pushes fixes when CI fails or reviewers leave comments.', 'before': None, 'after': None},
    {'headline': '/batch — Orchestrate large-scale changes across a codebase in parallel.', 'before': None, 'after': None},
    {'headline': '/branch — Create a branch of the current conversation at this point.', 'before': None, 'after': None},
    {'headline': '/btw — Ask a quick side question without adding to the conversation', 'before': None, 'after': None},
    {'headline': '/chrome — Configure Claude in Chrome settings', 'before': None, 'after': None},
    {'headline': '/claude-api — Load Claude API reference material for your project’s language (Python, TypeScript, Java, Go, Ruby, C#, PHP, or cURL) and Managed Agents reference.', 'before': None, 'after': None},
    {'headline': '/clear — Start a new conversation with empty context.', 'before': None, 'after': None},
    {'headline': '/color — Set the prompt bar color for the current session.', 'before': None, 'after': None},
    {'headline': '/compact — Free up context by summarizing the conversation so far.', 'before': None, 'after': None},
    {'headline': '/config — Open the Settings interface to adjust theme, model, output style, and other preferences.', 'before': None, 'after': None},
    {'headline': '/context — Visualize current context usage as a colored grid.', 'before': None, 'after': None},
    {'headline': '/copy — Copy the last assistant response to clipboard.', 'before': None, 'after': None},
    {'headline': '/cost — Alias for /usage', 'before': None, 'after': None},
    {'headline': '/debug — Enable debug logging for the current session and troubleshoot issues by reading the session debug log.', 'before': None, 'after': None},
    {'headline': '/desktop — Continue the current session in the Claude Code Desktop app.', 'before': None, 'after': None},
    {'headline': '/diff — Open an interactive diff viewer showing uncommitted changes and per-turn diffs.', 'before': None, 'after': None},
    {'headline': '/doctor — Diagnose and verify your Claude Code installation and settings.', 'before': None, 'after': None},
    {'headline': '/effort — Set the model effort level.', 'before': None, 'after': None},
    {'headline': '/exit — Exit the CLI.', 'before': None, 'after': None},
    {'headline': '/export — Export the current conversation as plain text.', 'before': None, 'after': None},
    {'headline': '/extra-usage — Configure extra usage to keep working when rate limits are hit', 'before': None, 'after': None},
    {'headline': '/fast — Toggle fast mode on or off', 'before': None, 'after': None},
    {'headline': '/feedback — Submit feedback about Claude Code.', 'before': None, 'after': None},
    {'headline': '/fewer-permission-prompts — Scan your transcripts for common read-only Bash and MCP tool calls, then add a prioritized allowlist to project .claude/settings.json to reduce permission prompts', 'before': None, 'after': None},
    {'headline': '/focus — Toggle the focus view, which shows only your last prompt, a one-line tool-call summary with edit diffstats, and the final response.', 'before': None, 'after': None},
    {'headline': '/heapdump — Write a JavaScript heap snapshot and a memory breakdown to ~/Desktop, or your home directory on Linux without a Desktop folder, for diagnosing high memory usage.', 'before': None, 'after': None},
    {'headline': '/help — Show help and available commands', 'before': None, 'after': None},
    {'headline': '/hooks — View hook configurations for tool events', 'before': None, 'after': None},
    # AUTO-GENERATED:END
]
