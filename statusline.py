...
_TIPS = [
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/best-practices fetched=2026-07-13
    ...
    {'headline': '**In one prompt**: ask Claude to run the check and iterate in the same message, as in the table above.', 'tier': 2, 'category': 'verification', 'before': None, 'after': None},
    {'headline': '**Across a session**: set the check as a [`/goal` condition](/docs/en/goal). A separate evaluator re-checks it after every turn and Claude keeps working until it holds.', 'tier': 2, 'category': 'verification', 'before': None, 'after': None},
    {'headline': '**As a deterministic gate**: a [Stop hook](/docs/en/hooks#stop) runs your check as a script and blocks the turn from ending until it passes. Claude Code overrides the hook and ends the turn after 8 consecutive blocks.', 'tier': 2, 'category': 'verification', 'before': None, 'after': None},
    {'headline': '**By a second opinion**: a [verification subagent](/docs/en/sub-agents) or a [dynamic workflow](/docs/en/workflows) that checks its own findings has a fresh model try to refute the result, so the agent doing the work isn’t the one grading it.', 'tier': 1, 'category': 'verification', 'before': None, 'after': None},
    ...
    {'headline': '**Child directories**: Claude pulls in child CLAUDE.md files on demand when it reads a file in those directories', 'tier': 1, 'category': 'general', 'before': None, 'after': None},
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/commands fetched=2026-07-13
    ...
    {'headline': '/advisor — Enable or disable the advisor tool, which consults a second model for guidance at key moments during a task.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/agents — As of v2.1.198, running /agents prints a reminder to ask Claude to create or manage subagents, or to edit .claude/agents/ or ~/.claude/agents/ directly.', 'tier': 1, 'category': 'permissions', 'before': None, 'after': None},
    ...
    {'headline': '/branch — Create a branch of the current conversation at this point, so you can try a different direction without losing the conversation as it stands.', 'tier': 2, 'category': 'verification', 'before': None, 'after': None},
    {'headline': '/btw — Ask a quick side question without adding to the conversation', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/cd — Move this session to a new working directory.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/code-review — Review the current diff for correctness bugs and for reuse, simplification, and efficiency cleanups.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/dataviz — Design guidance for charts, graphs, and dashboards.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/deep-research — Fan out web searches on a question, fetch and cross-check sources, and synthesize a cited report', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/design-login — Authorize design-system access for /design-sync with your claude.ai account', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/design-sync — Convert your repo’s React design system and upload it to Claude Design, so designs it produces use your real components.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/doctor — Run a setup checkup that diagnoses issues and can fix them.', 'tier': 3, 'category': 'recovery', 'before': None, 'after': None},
    ...
    {'headline': '/feedback — Submit feedback, report a bug, or share your conversation.', 'tier': 1, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/fork — Spawn a forked subagent: a background subagent that inherits the full conversation and works on the directive while you keep going.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/install-github-app — Install the Claude GitHub App for a repository, with an optional step to set up GitHub Actions workflows and secrets.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/install-slack-app — Install the Claude Slack app.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/keybindings — Open your keyboard shortcuts file', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/model — Switch the AI model and save it as your default for new sessions.', 'tier': 1, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/radio — Open Claude FM lo-fi radio in your browser.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/reload-skills — Re-scan skill and command directories so skills added or changed on disk during the session become available without restarting.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/remote-env — Choose the default environment for cloud agents', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/review — Run a fast single-pass, read-only review of a GitHub pull request by number.', 'tier': 1, 'category': 'verification', 'before': None, 'after': None},
    ...
    {'headline': '/run — Launch and drive your project’s app to see a change working, not only passing tests.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/run-skill-generator — Teach /run and /verify how to build, launch, and drive your project’s app from a clean environment by writing a per-project skill.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/setup-vertex — Configure Google Cloud’s Agent Platform authentication, project, region, and model pins through an interactive wizard.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/simplify — Review the changed code for cleanup opportunities and apply the fixes.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/status — Open the Settings interface on the Status tab, showing version, model, account, and connectivity.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/tasks — View and manage everything running in the background.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/usage-credits — Configure usage credits to keep working when you hit a limit.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    {'headline': '/verify — Confirm a code change does what it should by building your project’s app, running it, and observing the result, rather than relying on tests or type checks.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/workflows — Open the workflow progress view to watch, pause, resume, or save running and completed workflows', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    # AUTO-GENERATED:END
]
