...
_TIPS = [
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/best-practices fetched=2026-06-15
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/commands fetched=2026-06-15
