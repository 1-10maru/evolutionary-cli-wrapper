...
_TIPS = [
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/best-practices fetched=2026-07-06
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/commands fetched=2026-07-06
    ...
    {'headline': '/review — Review a GitHub pull request by number, using the same review engine as /code-review.', 'tier': 1, 'category': 'verification', 'before': None, 'after': None},
