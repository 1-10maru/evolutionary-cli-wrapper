...
_TIPS = [
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/best-practices fetched=2026-05-25
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/commands fetched=2026-05-25
    ...
    {'headline': '/code-review — Review the current diff for correctness bugs and report findings without editing files.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
    ...
    {'headline': '/model — Set the AI model for the current session.', 'tier': 1, 'category': 'general', 'before': None, 'after': None},
