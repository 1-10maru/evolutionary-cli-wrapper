...
_TIPS = [
    ...
    {'headline': '[Claude Developer Platform](https://platform.claude.com/)', 'before': None, 'after': None},
    {'headline': '[Claude Code on the Web](https://claude.ai/code)', 'before': None, 'after': None},
    {'headline': 'Claude Code on the web', 'before': None, 'after': None},
    {'headline': 'Claude Code on desktop', 'before': None, 'after': None},
    {'headline': 'Code review & CI/CD', 'before': None, 'after': None},
    {'headline': '[Give Claude a way to verify its work](#give-claude-a-way-to-verify-its-work)', 'before': None, 'after': None},
    {'headline': '[Explore first, then plan, then code](#explore-first-then-plan-then-code)', 'before': None, 'after': None},
    {'headline': '[Provide specific context in your prompts](#provide-specific-context-in-your-prompts)', 'before': None, 'after': None},
    {'headline': '[Provide rich content](#provide-rich-content)', 'before': None, 'after': None},
    {'headline': '[Configure your environment](#configure-your-environment)', 'before': None, 'after': None},
    {'headline': '[Write an effective CLAUDE.md](#write-an-effective-claude-md)', 'before': None, 'after': None},
    {'headline': '[Configure permissions](#configure-permissions)', 'before': None, 'after': None},
    {'headline': '[Use CLI tools](#use-cli-tools)', 'before': None, 'after': None},
    {'headline': '[Connect MCP servers](#connect-mcp-servers)', 'before': None, 'after': None},
    {'headline': '[Set up hooks](#set-up-hooks)', 'before': None, 'after': None},
    {'headline': '[Create skills](#create-skills)', 'before': None, 'after': None},
    {'headline': '[Create custom subagents](#create-custom-subagents)', 'before': None, 'after': None},
    {'headline': '[Install plugins](#install-plugins)', 'before': None, 'after': None},
    {'headline': '[Communicate effectively](#communicate-effectively)', 'before': None, 'after': None},
    {'headline': '[Ask codebase questions](#ask-codebase-questions)', 'before': None, 'after': None},
    {'headline': '[Let Claude interview you](#let-claude-interview-you)', 'before': None, 'after': None},
    {'headline': '[Manage your session](#manage-your-session)', 'before': None, 'after': None},
    {'headline': '[Course-correct early and often](#course-correct-early-and-often)', 'before': None, 'after': None},
    {'headline': '[Manage context aggressively](#manage-context-aggressively)', 'before': None, 'after': None},
    {'headline': '[Use subagents for investigation](#use-subagents-for-investigation)', 'before': None, 'after': None},
    {'headline': '[Rewind with checkpoints](#rewind-with-checkpoints)', 'before': None, 'after': None},
    {'headline': '[Resume conversations](#resume-conversations)', 'before': None, 'after': None},
    {'headline': '[Automate and scale](#automate-and-scale)', 'before': None, 'after': None},
    {'headline': '[Run non-interactive mode](#run-non-interactive-mode)', 'before': None, 'after': None},
    {'headline': '[Run multiple Claude sessions](#run-multiple-claude-sessions)', 'before': None, 'after': None},
    # AUTO-GENERATED:END
