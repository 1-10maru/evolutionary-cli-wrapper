...
_TIPS = [
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/best-practices fetched=2026-06-29
    ...
    # AUTO-GENERATED:START source=https://code.claude.com/docs/en/commands fetched=2026-06-29
    ...
    {'headline': '/run — Launch and drive your project’s app to see a change working in the running app, not just in tests.', 'tier': 2, 'category': 'general', 'before': None, 'after': None},
