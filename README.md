...
「その頼み方、かなりハマってる」  
「あと一言足すと、次の往復がけっこう減りそう」  
みたいなヒントを、作業の流れを邪魔しすぎない 1 行で返します。
...
```text
🐣 EvoPet ごきげん | 関数名か対象ファイル名を 1 個足すと刺さりやすい | 18%浮きそう | +4 vibe | Bond 42%
```
